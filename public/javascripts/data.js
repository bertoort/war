...
if (analyze) {
  analyze.addEventListener('click', function (e) {
    ...
    console.log('rounds: ' + rounds/games.value, 'wars: ' + wars/games.value, 'doublewars: ' + doubleWar/games.value);
    winnerAceCount.forEach(function (e, i) {
      console.log(i + ' ace win: ' + (e.win/e.start)*100 + '%' + ' total start games: ' + e.start);
    })
